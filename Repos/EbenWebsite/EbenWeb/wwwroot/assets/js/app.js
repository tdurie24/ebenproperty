$(function () {
   ...
   $(".dropdown").on('hover', function () {
    ...
    function LoadMap(propertes) {
        var defaultLat = -26.0268666 ;
        var defaultLng = 27.9632581;
        var mapOptions = {
        ...
        var myLatlng = new google.maps.LatLng(-26.0268666, 27.9632581);
        ...
        (function (marker) {
            google.maps.event.addListener(marker, "click", function (e) {
                infoWindow.setContent("" +
                    ...
                    "<p class='address'>19 Rooikrans road, Bloubosrand, Randburg, 2188 </p>" +
                    "<ul class='map-properties-list'> " +
                    "<li><i class='fa fa-phone'></i>  +27837711778</li> " +
                    "<li><i class='fa fa-envelope'></i>  info@ebenproperty.co.za</li> " +
                    "<li><a href='index.html'><i class='fa fa-globe'></i>  https://ebenproperty.co.za</li></a> " +
                    "</ul>" +
                    "</div>" +
                    "</div>");
    ...
    $( function() {
        ...
        var endDate = "October  17, 2020 15:03:25";
